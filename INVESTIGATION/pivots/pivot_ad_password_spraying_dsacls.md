# Pivot d’investigation – ad_password_spraying_dsacls

## Pivot de départ
Point d’entrée : activité détectée par la règle `ad_password_spraying_dsacls`.
...
```spl
index=* <conditions liées à ad_password_spraying_dsacls>
```
