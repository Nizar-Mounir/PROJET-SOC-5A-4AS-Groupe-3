# Pivot d’investigation – ad_kerberoasting_initial_query

## Pivot de départ
Point d’entrée : activité détectée par la règle `ad_kerberoasting_initial_query`.
...
```spl
index=* <conditions liées à ad_kerberoasting_initial_query>
```
