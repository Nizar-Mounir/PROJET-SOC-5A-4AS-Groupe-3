# Pivot d’investigation – ad_shadow_credentials

## Pivot de départ
Point d’entrée : activité détectée par la règle `ad_shadow_credentials`.
...
```spl
index=* <conditions liées à ad_shadow_credentials>
```
