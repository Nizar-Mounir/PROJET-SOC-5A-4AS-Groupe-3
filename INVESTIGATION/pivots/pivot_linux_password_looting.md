# Pivot d’investigation – linux_password_looting

## Pivot de départ
Point d’entrée : activité détectée par la règle `linux_password_looting`.
...
```spl
index=* <conditions liées à linux_password_looting>
```
