# Pivot d’investigation – linux_access_etc_shadow

## Pivot de départ
Point d’entrée : activité détectée par la règle `linux_access_etc_shadow`.
...
```spl
index=* <conditions liées à linux_access_etc_shadow>
```
