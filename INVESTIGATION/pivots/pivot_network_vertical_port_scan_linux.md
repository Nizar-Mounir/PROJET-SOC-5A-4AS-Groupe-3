# Pivot d’investigation – network_vertical_port_scan_linux

## Pivot de départ
Point d’entrée : activité détectée par la règle `network_vertical_port_scan_linux`.
...
```spl
index=* <conditions liées à network_vertical_port_scan_linux>
```
