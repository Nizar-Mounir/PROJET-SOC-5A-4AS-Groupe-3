# Pivot d’investigation – ad_kerberoasting_simple

## Pivot de départ
Point d’entrée : activité détectée par la règle `ad_kerberoasting_simple`.
...
```spl
index=* <conditions liées à ad_kerberoasting_simple>
```
