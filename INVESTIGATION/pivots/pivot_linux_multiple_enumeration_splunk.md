# Pivot d’investigation – linux_multiple_enumeration_splunk

## Pivot de départ
Point d’entrée : activité détectée par la règle `linux_multiple_enumeration_splunk`.
...
```spl
index=* <conditions liées à linux_multiple_enumeration_splunk>
```
