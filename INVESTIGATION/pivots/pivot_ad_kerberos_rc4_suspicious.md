# Pivot d’investigation – ad_kerberos_rc4_suspicious

## Pivot de départ
Point d’entrée : activité détectée par la règle `ad_kerberos_rc4_suspicious`.
...
```spl
index=* <conditions liées à ad_kerberos_rc4_suspicious>
```
