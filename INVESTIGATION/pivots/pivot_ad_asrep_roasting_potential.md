# Pivot d’investigation – ad_asrep_roasting_potential

## Pivot de départ
Point d’entrée : activité détectée par la règle `ad_asrep_roasting_potential`.
...
```spl
index=* <conditions liées à ad_asrep_roasting_potential>
```
