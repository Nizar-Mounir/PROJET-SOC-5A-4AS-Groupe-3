# Workflow d’investigation – linux_multiple_enumeration_commands

## Objectif
Décrire les étapes suivies par un analyste N1/N2 pour investiguer une alerte générée par `linux_multiple_enumeration_commands`.
