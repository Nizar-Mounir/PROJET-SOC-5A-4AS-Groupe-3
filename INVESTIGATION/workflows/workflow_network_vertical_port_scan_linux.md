# Workflow d’investigation – network_vertical_port_scan_linux

## Objectif
Décrire les étapes suivies par un analyste N1/N2 pour investiguer une alerte générée par `network_vertical_port_scan_linux`.
