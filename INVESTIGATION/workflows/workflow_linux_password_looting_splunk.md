# Workflow d’investigation – linux_password_looting_splunk

## Objectif
Décrire les étapes suivies par un analyste N1/N2 pour investiguer une alerte générée par `linux_password_looting_splunk`.
