# Workflow d’investigation – windows_service_creation_suspect

## Objectif
Décrire les étapes suivies par un analyste N1/N2 pour investiguer une alerte générée par `windows_service_creation_suspect`.
