# Workflow d’investigation – ad_kerberos_rc4_suspicious

## Objectif
Décrire les étapes suivies par un analyste N1/N2 pour investiguer une alerte générée par `ad_kerberos_rc4_suspicious`.
