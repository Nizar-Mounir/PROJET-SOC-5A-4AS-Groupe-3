# Workflow d’investigation – ad_kerberoasting_initial_query

## Objectif
Décrire les étapes suivies par un analyste N1/N2 pour investiguer une alerte générée par `ad_kerberoasting_initial_query`.
