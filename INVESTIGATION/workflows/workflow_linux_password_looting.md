# Workflow d’investigation – linux_password_looting

## Objectif
Décrire les étapes suivies par un analyste N1/N2 pour investiguer une alerte générée par `linux_password_looting`.
