# Workflow d’investigation – windows_scheduled_task_creation

## Objectif
Décrire les étapes suivies par un analyste N1/N2 pour investiguer une alerte générée par `windows_scheduled_task_creation`.
