# Fiche réflexe – ad_kerberoasting_initial_query

## Contexte
Détection générée par la règle `ad_kerberoasting_initial_query`. Une activité potentiellement malveillante a été identifiée par le SOC.
...
## SPL complémentaires
```spl
index=* <conditions liées à la règle ad_kerberoasting_initial_query>
```
