# Fiche réflexe – network_horizontal_port_scan_linux

## Contexte
Détection générée par la règle `network_horizontal_port_scan_linux`. Une activité potentiellement malveillante a été identifiée par le SOC.
...
## SPL complémentaires
```spl
index=* <conditions liées à la règle network_horizontal_port_scan_linux>
```
