# Fiche réflexe – linux_password_looting

## Contexte
Détection générée par la règle `linux_password_looting`. Une activité potentiellement malveillante a été identifiée par le SOC.
...
## SPL complémentaires
```spl
index=* <conditions liées à la règle linux_password_looting>
```
