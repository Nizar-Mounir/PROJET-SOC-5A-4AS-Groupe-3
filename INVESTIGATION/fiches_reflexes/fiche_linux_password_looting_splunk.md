# Fiche réflexe – linux_password_looting_splunk

## Contexte
Détection générée par la règle `linux_password_looting_splunk`. Une activité potentiellement malveillante a été identifiée par le SOC.
...
## SPL complémentaires
```spl
index=* <conditions liées à la règle linux_password_looting_splunk>
```
