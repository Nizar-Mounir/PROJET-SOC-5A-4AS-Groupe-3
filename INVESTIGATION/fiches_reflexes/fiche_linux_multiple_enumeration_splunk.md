# Fiche réflexe – linux_multiple_enumeration_splunk

## Contexte
Détection générée par la règle `linux_multiple_enumeration_splunk`. Une activité potentiellement malveillante a été identifiée par le SOC.
...
## SPL complémentaires
```spl
index=* <conditions liées à la règle linux_multiple_enumeration_splunk>
```
