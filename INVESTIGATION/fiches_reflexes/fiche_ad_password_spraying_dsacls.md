# Fiche réflexe – ad_password_spraying_dsacls

## Contexte
Détection générée par la règle `ad_password_spraying_dsacls`. Une activité potentiellement malveillante a été identifiée par le SOC.
...
## SPL complémentaires
```spl
index=* <conditions liées à la règle ad_password_spraying_dsacls>
```
