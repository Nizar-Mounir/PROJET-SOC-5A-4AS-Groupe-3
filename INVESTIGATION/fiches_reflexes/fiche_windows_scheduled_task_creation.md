# Fiche réflexe – windows_scheduled_task_creation

## Contexte
Détection générée par la règle `windows_scheduled_task_creation`. Une activité potentiellement malveillante a été identifiée par le SOC.
...
## SPL complémentaires
```spl
index=* <conditions liées à la règle windows_scheduled_task_creation>
```
