# Fiche réflexe – windows_service_creation_suspect

## Contexte
Détection générée par la règle `windows_service_creation_suspect`. Une activité potentiellement malveillante a été identifiée par le SOC.
...
## SPL complémentaires
```spl
index=* <conditions liées à la règle windows_service_creation_suspect>
```
