# Fiche réflexe – linux_access_etc_shadow

## Contexte
Détection générée par la règle `linux_access_etc_shadow`. Une activité potentiellement malveillante a été identifiée par le SOC.
...
## SPL complémentaires
```spl
index=* <conditions liées à la règle linux_access_etc_shadow>
```
