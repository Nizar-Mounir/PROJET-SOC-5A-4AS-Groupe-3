# Fiche réflexe – linux_uid0_abuse

## Contexte
Détection générée par la règle `linux_uid0_abuse`. Une activité potentiellement malveillante a été identifiée par le SOC.
...
## SPL complémentaires
```spl
index=* <conditions liées à la règle linux_uid0_abuse>
```
