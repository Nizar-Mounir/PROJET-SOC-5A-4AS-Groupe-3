# Fiche réflexe – linux_multiple_enumeration_commands

## Contexte
Détection générée par la règle `linux_multiple_enumeration_commands`. Une activité potentiellement malveillante a été identifiée par le SOC.
...
## SPL complémentaires
```spl
index=* <conditions liées à la règle linux_multiple_enumeration_commands>
```
