# Fiche réflexe – ad_shadow_credentials

## Contexte
Détection générée par la règle `ad_shadow_credentials`. Une activité potentiellement malveillante a été identifiée par le SOC.
...
## SPL complémentaires
```spl
index=* <conditions liées à la règle ad_shadow_credentials>
```
