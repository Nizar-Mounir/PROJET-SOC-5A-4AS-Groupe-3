# Fiche réflexe – linux_suspicious_download_commands

## Contexte
Détection générée par la règle `linux_suspicious_download_commands`. Une activité potentiellement malveillante a été identifiée par le SOC.
...
## SPL complémentaires
```spl
index=* <conditions liées à la règle linux_suspicious_download_commands>
```
