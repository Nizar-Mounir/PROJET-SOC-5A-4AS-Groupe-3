# Fiche réflexe – ad_asrep_roasting_bruteforce

## Contexte
Détection générée par la règle `ad_asrep_roasting_bruteforce`. Une activité potentiellement malveillante a été identifiée par le SOC.
...
## SPL complémentaires
```spl
index=* <conditions liées à la règle ad_asrep_roasting_bruteforce>
```
